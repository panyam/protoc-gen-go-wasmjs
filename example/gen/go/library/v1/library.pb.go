...
const file_library_v1_library_proto_rawDesc = "" +
	...
	"\n" +
	"CreateUser\x12\x1d.library.v1.CreateUserRequest\x1a\x1e.library.v1.CreateUserResponse\"\x04\x98\xb5\x18\x01B\xb3\x01\n" +
	"\x0ecom.library.v1B\fLibraryProtoP\x01ZJgithub.com/panyam/protoc-gen-go-wasmjs/example/gen/go/library/v1;libraryv1\xa2\x02\x03LXX\xaa\x02\n" +
	"Library.V1\xca\x02\n" +
