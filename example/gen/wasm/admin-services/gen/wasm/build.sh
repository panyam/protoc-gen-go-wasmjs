...
# Build script for admin_services WASM module

set -e

echo "Building admin_services WASM module..."
...
go build -o admin_services.wasm admin_services.wasm.go
...
echo "  - admin_services.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("admin_services.wasm"), go.importObject)'
