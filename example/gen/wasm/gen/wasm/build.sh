...
# Build script for library_v1_services WASM module

set -e

echo "Building library_v1_services WASM module..."
...
echo "  - library_v1_services.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("library_v1_services.wasm"), go.importObject)'
