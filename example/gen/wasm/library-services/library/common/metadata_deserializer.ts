...
import { FieldType, FieldSchema, MessageSchema } from "./metadata_schemas";

/**
 * Factory interface that deserializer expects
 */
export interface FactoryInterface {
  [key: string]: (parent?: any, attributeName?: string, attributeKey?: string | number, data?: any) => FactoryResult<any>;
...
export class LibraryCommonDeserializer {
   ...
   */
  createAndDeserialize<T>(messageType: string, data: any): T | null {
    // Try to get factory method using cross-package delegation
    let factoryMethod;
