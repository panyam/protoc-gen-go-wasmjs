...
export class Library_servicesClient {
     ...
     */
    public async loadWasm(wasmPath: string = './library_services.wasm'): Promise<void> {
    ...
    private async loadWASMModule(wasmPath: string): Promise<void> {
        ...
        console.log('library_services WASM module loaded successfully');
    }
...
class LibraryServiceClientImpl implements LibraryServiceMethods {
    constructor(private parent: Library_servicesClient) {}
...
export default Library_servicesClient;