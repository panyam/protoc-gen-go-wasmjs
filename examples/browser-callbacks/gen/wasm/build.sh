...
# Build script for browser_example WASM module

set -e

echo "Building browser_example WASM module..."
...
go build -o browser_example.wasm browser_example.wasm.go
...
echo "  - browser_example.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("browser_example.wasm"), go.importObject)'
