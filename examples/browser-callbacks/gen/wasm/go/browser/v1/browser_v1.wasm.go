...
func (exports *Browser_v1ServicesExports) RegisterAPI() {
	fmt.Println("browser_v1_services WASM module loading...")

	// Initialize browser channel for browser-provided services
	_ = wasm.GetBrowserChannel()
	// Create namespaced API structure
	browser_v1 := map[string]interface{}{}
	js.Global().Set("browser_v1", js.ValueOf(browser_v1))

	fmt.Println("browser_v1_services WASM module loaded successfully")
}
