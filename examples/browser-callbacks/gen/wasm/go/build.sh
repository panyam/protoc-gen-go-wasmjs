...
# Build script for presenter_v1_services WASM module

set -e

echo "Building presenter_v1_services WASM module..."
...
go build -o presenter_v1_services.wasm presenter_v1_services.wasm.go
...
echo "  - presenter_v1_services.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("presenter_v1_services.wasm"), go.importObject)'
