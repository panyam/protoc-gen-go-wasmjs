...
# Build script for browser_callbacks WASM module

set -e

echo "Building browser_callbacks WASM module..."
...
echo "  - browser_callbacks.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("browser_callbacks.wasm"), go.importObject)'
