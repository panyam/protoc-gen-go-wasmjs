...
func (exports *Presenter_v1ServicesExports) RegisterAPI() {
	fmt.Println("browser_callbacks WASM module loading...")
	// Create namespaced API structure
	browserCallbacks := map[string]interface{}{
	...
	js.Global().Set("browserCallbacks", js.ValueOf(browserCallbacks))

	fmt.Println("browser_callbacks WASM module loaded successfully")
}
