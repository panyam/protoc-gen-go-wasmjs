...
class Presenter_v1_servicesClient {
  constructor() {
   ...
   */
  async loadWasm(wasmPath = "./presenter_v1_services.wasm") {
...
class PresenterServiceClientImpl {
  ...
  async runCallbackDemo(request) {
    return this.parent.callMethod("presenterService.runCallbackDemo", request);
  }
}
var presenter_v1_servicesClient_client_default = Presenter_v1_servicesClient;
export {
  BrowserServiceManager,
  Presenter_v1_servicesClient,
  WasmError,
  presenter_v1_servicesClient_client_default as default
};
