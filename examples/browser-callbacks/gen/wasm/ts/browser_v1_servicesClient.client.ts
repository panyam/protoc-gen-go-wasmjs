...
// =============================================================================
/**
 * BrowserAPI browser service interface
 * Implement this interface to provide browser functionality to WASM
 */
export interface BrowserAPIServer {
	fetch(request: any): Promise<any> | any;
	getLocalStorage(request: any): Promise<any> | any;
	setLocalStorage(request: any): Promise<any> | any;
	getCookie(request: any): Promise<any> | any;
	alert(request: any): Promise<any> | any;
	promptUser(request: any): Promise<any> | any;
	logToWindow(request: any): Promise<any> | any;
}

/**
 * browser_v1_services WASM client
 * Provides a clean interface between UI components and the Go WASM service implementations
 */
export class Browser_v1_servicesClient {
    private wasm: any;
     ...
     */
    public async loadWasm(wasmPath: string = './browser_v1_services.wasm'): Promise<void> {
...
export default Browser_v1_servicesClient;