...
import { LoadUserDataRequest as ConcreteLoadUserDataRequest, LoadUserDataResponse as ConcreteLoadUserDataResponse, StateUpdateRequest as ConcreteStateUpdateRequest, UIUpdate as ConcreteUIUpdate, TestRecord as ConcreteTestRecord, PreferencesRequest as ConcretePreferencesRequest, PreferencesResponse as ConcretePreferencesResponse, CallbackDemoRequest as ConcreteCallbackDemoRequest, CallbackDemoResponse as ConcreteCallbackDemoResponse } from "./models";
...
export class Presenter_v1Factory {
  ...
  /**
   * Enhanced factory method for LoadUserDataRequest
   ...
   */
  newLoadUserDataRequest = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<LoadUserDataRequestInterface> => {
    const out = new ConcreteLoadUserDataRequest();
  ...
  /**
   * Enhanced factory method for LoadUserDataResponse
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newLoadUserDataResponse = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<LoadUserDataResponseInterface> => {
    const out = new ConcreteLoadUserDataResponse();
  ...
  /**
   * Enhanced factory method for TestRecord
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
  ...
  newTestRecord = (
    ...
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<TestRecordInterface> => {
    const out = new ConcreteTestRecord();
