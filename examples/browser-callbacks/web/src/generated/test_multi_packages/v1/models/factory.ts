...
import { SampleRequest as ConcreteSampleRequest, SampleResponse as ConcreteSampleResponse } from "./models";
 ...
 */
export class Test_multi_packages_v1_modelsFactory {
  ...
  getFactoryMethod(messageType: string): ((parent?: any, attributeName?: string, attributeKey?: string | number, data?: any) => FactoryResult<any>) | undefined {
    ...
    const currentPackage = "test_multi_packages.v1.models";
