...
import { ModelWithOptionalAndDefaults as ConcreteModelWithOptionalAndDefaults, HelperUtilType as ConcreteHelperUtilType, NestedUtilType as ConcreteNestedUtilType, ParentUtilMessage as ConcreteParentUtilMessage, ParentUtilMessage_NestedUtilType as ConcreteParentUtilMessage_NestedUtilType } from "./models";
 ...
 */
export class Utils_v1Factory {


  /**
   * Enhanced factory method for ModelWithOptionalAndDefaults
   ...
   */
  newModelWithOptionalAndDefaults = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<ModelWithOptionalAndDefaultsInterface> => {
    const out = new ConcreteModelWithOptionalAndDefaults();
  ...
  /**
   * Enhanced factory method for HelperUtilType
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
  ...
  newHelperUtilType = (
    ...
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<HelperUtilTypeInterface> => {
    const out = new ConcreteHelperUtilType();
  ...
  /**
   * Enhanced factory method for NestedUtilType
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
  ...
  newNestedUtilType = (
    ...
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<NestedUtilTypeInterface> => {
    const out = new ConcreteNestedUtilType();
  ...
  /**
   * Enhanced factory method for ParentUtilMessage
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newParentUtilMessage = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<ParentUtilMessageInterface> => {
    const out = new ConcreteParentUtilMessage();
  ...
  /**
   * Enhanced factory method for ParentUtilMessage_NestedUtilType
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newParentUtilMessage_NestedUtilType = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<ParentUtilMessage_NestedUtilTypeInterface> => {
    const out = new ConcreteParentUtilMessage_NestedUtilType();
