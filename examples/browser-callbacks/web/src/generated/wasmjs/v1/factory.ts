...
import { StatefulOptions as ConcreteStatefulOptions, StatefulMethodOptions as ConcreteStatefulMethodOptions, AsyncMethodOptions as ConcreteAsyncMethodOptions, MessagePatch as ConcreteMessagePatch, PatchBatch as ConcretePatchBatch, PatchResponse as ConcretePatchResponse } from "./models";
...
export class Wasmjs_v1Factory {
  ...
  newStatefulOptions = (
    ...
    data?: any
  ): FactoryResult<StatefulOptionsInterface> => {
   ...
   * @returns Factory result with instance and population status
   */
  newStatefulMethodOptions = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<StatefulMethodOptionsInterface> => {
  ...
  /**
   * Enhanced factory method for AsyncMethodOptions
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newAsyncMethodOptions = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<AsyncMethodOptionsInterface> => {
    const out = new ConcreteAsyncMethodOptions();
  ...
  newMessagePatch = (
    ...
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<MessagePatchInterface> => {
  ...
  newPatchBatch = (
    ...
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<PatchBatchInterface> => {
  ...
  newPatchResponse = (
    ...
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<PatchResponseInterface> => {
