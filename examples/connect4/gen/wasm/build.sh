...
# Build script for multiplayer_connect4 WASM module

set -e

echo "Building multiplayer_connect4 WASM module..."
...
go build -o multiplayer_connect4.wasm multiplayer_connect4.wasm.go
...
echo "  - multiplayer_connect4.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("multiplayer_connect4.wasm"), go.importObject)'
