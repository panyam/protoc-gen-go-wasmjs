...
# Build script for connect4_game WASM module

set -e

echo "Building connect4_game WASM module..."
...
go build -o connect4_game.wasm connect4_game.wasm.go
...
echo "  - connect4_game.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("connect4_game.wasm"), go.importObject)'
