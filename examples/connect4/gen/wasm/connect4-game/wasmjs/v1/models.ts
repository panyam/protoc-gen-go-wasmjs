import { StatefulOptions as StatefulOptionsInterface, StatefulMethodOptions as StatefulMethodOptionsInterface, MessagePatch as MessagePatchInterface, PatchBatch as PatchBatchInterface, PatchResponse as PatchResponseInterface } from "./interfaces";
...
export class StatefulOptions implements StatefulOptionsInterface {
 ...
 (e.g., "example.Game", "library.Map") */
  ...
  static from(data: any) {
    return WasmjsV1Deserializer.from<StatefulOptions>(StatefulOptions.MESSAGE_TYPE, data);
  }
}
...
export class StatefulMethodOptions implements StatefulMethodOptionsInterface {
   ...
   */
  static from(data: any) {
    return WasmjsV1Deserializer.from<StatefulMethodOptions>(StatefulMethodOptions.MESSAGE_TYPE, data);
  }
}
...
export class MessagePatch implements MessagePatchInterface {
 ...
 Encoded as JSON for type flexibility */
   ...
   */
  static from(data: any) {
    return WasmjsV1Deserializer.from<MessagePatch>(MessagePatch.MESSAGE_TYPE, data);
  }
}
...
export class PatchBatch implements PatchBatchInterface {
   ...
   */
  static from(data: any) {
    return WasmjsV1Deserializer.from<PatchBatch>(PatchBatch.MESSAGE_TYPE, data);
  }
}
...
export class PatchResponse implements PatchResponseInterface {
   ...
   */
  static from(data: any) {
    return WasmjsV1Deserializer.from<PatchResponse>(PatchResponse.MESSAGE_TYPE, data);
  }
}
