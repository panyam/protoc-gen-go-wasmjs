...
import { Connect4ServiceClient } from '../../../../static/gen/multiplayer/wasmjs/v1';
import { 
  MessagePatch, 
  PatchBatch, 
  PatchOperation,
...
/**
 * Create a stateful proxy with a WASM client
 */
export function createStatefulConnect4ServiceProxy(entityId: string): StatefulConnect4ServiceProxy {
  const wasmClient = new Connect4ServiceClient();
  return new StatefulConnect4ServiceProxy(wasmClient, entityId);
}
