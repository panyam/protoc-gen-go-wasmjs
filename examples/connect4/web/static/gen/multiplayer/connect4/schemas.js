 ...
 */
export const DropPieceRequestSchema = {
 ...
 */
export const DropPieceResponseSchema = {
 ...
 */
export const PieceDropResultSchema = {
 ...
 */
export const Connect4SchemaRegistry = {
 ...
 */
export function getFieldSchema(messageType, fieldName) {
    const schema = getSchema(messageType);
    return schema === null || schema === void 0 ? void 0 : schema.fields.find(field => field.name === fieldName);
}
/**
 * Get field schema by proto field ID from connect4 package
 */
export function getFieldSchemaById(messageType, fieldId) {
    const schema = getSchema(messageType);
    return schema === null || schema === void 0 ? void 0 : schema.fields.find(field => field.id === fieldId);
}
/**
 * Check if field is part of a oneof group in connect4 package
 */
export function isOneofField(messageType, fieldName) {
    const fieldSchema = getFieldSchema(messageType, fieldName);
    return (fieldSchema === null || fieldSchema === void 0 ? void 0 : fieldSchema.oneofGroup) !== undefined;
}
/**
 * Get all fields in a oneof group from connect4 package
 */
export function getOneofFields(messageType, oneofGroup) {
    const schema = getSchema(messageType);
    return (schema === null || schema === void 0 ? void 0 : schema.fields.filter(field => field.oneofGroup === oneofGroup)) || [];
}
