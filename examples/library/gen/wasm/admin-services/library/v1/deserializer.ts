...
/**
 * Schema-aware deserializer for library.v1 package
 */
export class LibraryV1Deserializer {
  constructor(
    private schemaRegistry: Record<string, MessageSchema> = LibraryV1SchemaRegistry,
  ...
  static from<T>(messageType: string, data: any) {
    const deserializer = new LibraryV1Deserializer(); // Uses default factory and schema registry
