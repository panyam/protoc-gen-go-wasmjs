...
# Build script for library_all_services WASM module

set -e

echo "Building library_all_services WASM module..."
...
go build -o library_all_services.wasm library_all_services.wasm.go
...
echo "  - library_all_services.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("library_all_services.wasm"), go.importObject)'
