...
# Build script for library_services WASM module

set -e

echo "Building library_services WASM module..."
...
go build -o library_services.wasm library_services.wasm.go
...
echo "  - library_services.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("library_services.wasm"), go.importObject)'
