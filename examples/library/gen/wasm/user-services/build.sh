...
# Build script for user_services WASM module

set -e

echo "Building user_services WASM module..."
...
go build -o user_services.wasm user_services.wasm.go
...
echo "  - user_services.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("user_services.wasm"), go.importObject)'
