...
# Build script for streaming_service WASM module

set -e

echo "Building streaming_service WASM module..."
...
go build -o streaming_service.wasm streaming_service.wasm.go
...
echo "  - streaming_service.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("streaming_service.wasm"), go.importObject)'
