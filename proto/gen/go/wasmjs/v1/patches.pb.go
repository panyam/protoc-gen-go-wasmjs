...
type MessagePatch struct {
	...
	OldIndex *int32 `protobuf:"varint,6,opt,name=old_index,json=oldIndex,proto3,oneof" json:"old_index,omitempty"`
...
const file_wasmjs_v1_patches_proto_rawDesc = "" +
	"\n" +
	"\x17wasmjs/v1/patches.proto\x12\twasmjs.v1\"\xb9\x03\n" +
	"\fMessagePatch\x127\n" +
	"\toperation\x18\x01 \x01(\x0e2\x19.wasmjs.v1.PatchOperationR\toperation\x12\x1d\n" +
	"\n" +
	"field_path\x18\x02 \x01(\tR\tfieldPath\x12\"\n" +
	"\n" +
	"value_json\x18\x03 \x01(\tH\x00R\tvalueJson\x88\x01\x01\x12\x19\n" +
	"\x05index\x18\x04 \x01(\x05H\x01R\x05index\x88\x01\x01\x12\x15\n" +
	"\x03key\x18\x05 \x01(\tH\x02R\x03key\x88\x01\x01\x12 \n" +
	"\told_index\x18\x06 \x01(\x05H\x03R\boldIndex\x88\x01\x01\x12#\n" +
	...
	" \x01(\tH\x05R\rtransactionId\x88\x01\x01B\r\n" +
	"\v_value_jsonB\b\n" +
	"\x06_indexB\x06\n" +
	"\x04_keyB\f\n" +
	"\n" +
	...
	"\x11new_change_number\x18\x04 \x01(\x03R\x0fnewChangeNumberB\x10\n" +
...
func file_wasmjs_v1_patches_proto_init() {
	...
	file_wasmjs_v1_patches_proto_msgTypes[0].OneofWrappers = []any{}
	file_wasmjs_v1_patches_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
