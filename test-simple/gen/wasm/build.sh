...
# Build script for test_services WASM module

set -e

echo "Building test_services WASM module..."
...
go build -o test_services.wasm test_services.wasm.go
...
echo "  - test_services.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("test_services.wasm"), go.importObject)'
